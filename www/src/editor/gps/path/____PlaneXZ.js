    ...
    constructor( ) {
        ...
        this.upDate=function(){
            ...
            for (var i = 0; i < this.array.length; i+=2) {
                vertices.push(this.array[i].x+this.x,this.array[i].y+this.y,this.array[i].z+this.z);
                vertices.push(this.array[i+1].x+this.x,this.array[i+1].y+this.y,this.array[i+1].z+this.z);
            }
