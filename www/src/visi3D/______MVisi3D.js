...
MVisi3D.prototype = {
	...
	set rotationX (v) {
		...
		let or=this._rotationX
		this._rotationX = v;
		this.intRend = 1;
		this.gCam2.rotation.x = v;	
		this.gp2.rotation.x = v;
		//this.position3d.mppZdvig.korect("rotationX",this._rotationX,or)
	...
	set rotationZ (v) {
		...
		let or=this._rotationZ
		this._rotationZ = v;
		this.gCam1.rotation.z = v;
		this.gp1.rotation.z = v;
		this.position3d.mppZdvig.korect("rotationZ",this._rotationZ,or)
		this.intRend = 1;
